...
class CanSaveJourneyAndViewSavedJourney {
    ...
    @Test
    fun canSaveJourneyAndViewSavedJourney() {
        ...
        val materialButton8 = onView(
            allOf(
                withId(R.id.btnCompleteJourney), withText("Complete Journey"),
                childAtPosition(
                    allOf(
        ...
        val materialButton9 = onView(
            allOf(
                withId(R.id.btnSaveJourney), withText("Save Journey"),
                childAtPosition(
                    childAtPosition(
                        withClassName(`is`("androidx.coordinatorlayout.widget.CoordinatorLayout")),
                        1
        ...
        val textView = onView(
            allOf(
                withId(R.id.tvSavedJourneyNames),
                withText("EPIC 212737443 c, EPIC 248847494 b, GJ 1132 c, GJ 3021 b, "),
                withParent(withParent(withId(R.id.cardview_savedplanets))),
                isDisplayed()
            )
        )
        textView.check(matches(withText("EPIC 212737443 c, EPIC 248847494 b, GJ 1132 c, GJ 3021 b, ")))
    }
