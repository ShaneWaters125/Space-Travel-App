...
class CanFilterJourneyPlanetTemperature {
    ...
    @Test
    fun canFilterJourneyPlanetTemperature() {
        ...
        val appCompatSpinner = Espresso.onView(
                Matchers.allOf(ViewMatchers.withId(R.id.spnJourneyTemp),
                        childAtPosition(
                                childAtPosition(
        ...
        Espresso.onData(Matchers.equalTo("Cold")).inRoot(RootMatchers.isPlatformPopup()).perform(ViewActions.click())
