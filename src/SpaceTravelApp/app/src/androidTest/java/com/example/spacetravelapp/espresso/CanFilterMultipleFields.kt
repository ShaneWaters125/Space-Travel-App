...
class CanFilterMultipleFields {
    ...
    fun canFilterMultipleFields() {
        ...
        val textView = onView(
            allOf(
                withId(R.id.tvName), withText("GJ 1132 c"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.FrameLayout::class.java))),
                isDisplayed()
            )
        )
        textView.check(matches(withText("GJ 1132 c")))
    }
