...
class CanUnfavouritePlanet {
    ...
    fun canUnfavouritePlanet() {
        ...
        val textView = onView(
            allOf(
                withId(R.id.tvNumPlanets), withText("Showing 0 planets"),
                withParent(
                    allOf(
                        withId(R.id.constraintLayout),
        ...
        textView.check(matches(withText("Showing 0 planets")))
    }
