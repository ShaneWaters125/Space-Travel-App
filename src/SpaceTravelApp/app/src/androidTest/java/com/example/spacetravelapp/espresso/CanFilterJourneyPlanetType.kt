...
class CanFilterJourneyPlanetType {
    ...
    @Test
    fun canFilterJourneyPlanetType() {
        ...
        val appCompatSpinner = onView(
                allOf(withId(R.id.spnJourneyType),
                        childAtPosition(
                                childAtPosition(
        ...
        onData(equalTo("Ice or Rock/Mountain Planet")).inRoot(RootMatchers.isPlatformPopup()).perform(click())

        val appCompatImageButton11 = onView(
                allOf(withId(R.id.ibJourneyFilter), withContentDescription("Apply Filters"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(`is`("android.widget.LinearLayout")),
                                        3),
        ...
        val textView = onView(
                allOf(withId(R.id.tvJourneyPlanetName), withText("EPIC 248847494 b"),
                        withParent(withParent(withId(R.id.cardviewJourney))),
                        isDisplayed()))
        textView.check(matches(withText("EPIC 248847494 b")))
    }
