...
class CanFilterTemperature {
    ...
    fun canFilterTemperature() {
        ...
        val textView = onView(
            allOf(
                withId(R.id.tvName), withText("CFBDSIR J145829+101343 b"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.FrameLayout::class.java))),
                isDisplayed()
            )
        )
        textView.check(matches(withText("CFBDSIR J145829+101343 b")))
    }
