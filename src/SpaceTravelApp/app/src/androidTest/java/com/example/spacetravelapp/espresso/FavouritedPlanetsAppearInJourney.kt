...
class FavouritedPlanetsAppearInJourney {
    ...
    @Test
    fun favouritedPlanetsAppearInJourney() {
        ...
        val textView = onView(
            allOf(
                withId(R.id.tvJourneyPlanetName), withText("EPIC 212737443 c"),
                withParent(withParent(withId(R.id.cardviewJourney))),
                isDisplayed()
            )
        )
        textView.check(matches(withText("EPIC 212737443 c")))
    }
